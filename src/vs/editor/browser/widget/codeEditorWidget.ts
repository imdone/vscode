...
registerThemingParticipant((theme, collector) => {
	...
	if (unnecessaryForeground) {
		collector.addRule(`.${SHOW_UNUSED_ENABLED_CLASS} .monaco-editor .${ClassName.EditorUnnecessaryInlineDecoration} { opacity: ${unnecessaryForeground.rgba.a}; will-change: opacity; }`); // TODO 'will-change: opacity' is a workaround for https://github.com/Microsoft/vscode/issues/52196 id:106 @Ben:
	}
