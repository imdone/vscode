...
export class ProcessRunnerDetector {
	...
	private resolveCommandOptions(workspaceFolder: IWorkspaceFolder, options: CommandOptions): CommandOptions {
		// TODO adopt new configuration resolver service https://github.com/Microsoft/vscode/issues/31365 id:161 @Dirk
	...
	private tryDetectGulp(workspaceFolder: IWorkspaceFolder, list: boolean): TPromise<DetectorResult> {
		return this.fileService.resolveFile(workspaceFolder.toResource('gulpfile.js')).then((stat) => { // TODO (https://github.com/Microsoft/vscode/issues/29454) id:185 @Dirk
	...
	private tryDetectGrunt(workspaceFolder: IWorkspaceFolder, list: boolean): TPromise<DetectorResult> {
		return this.fileService.resolveFile(workspaceFolder.toResource('Gruntfile.js')).then((stat) => { // TODO (https://github.com/Microsoft/vscode/issues/29454) id:225 @Dirk
	...
	private tryDetectJake(workspaceFolder: IWorkspaceFolder, list: boolean): TPromise<DetectorResult> {
		...
		return this.fileService.resolveFile(workspaceFolder.toResource('Jakefile')).then((stat) => { // TODO (https://github.com/Microsoft/vscode/issues/29454) id:207 @Dirk
			return run();
		}, (err: any) => {
			return this.fileService.resolveFile(workspaceFolder.toResource('Jakefile.js')).then((stat) => { // TODO (https://github.com/Microsoft/vscode/issues/29454) id:133 @Dirk
				return run();
			}, (err: any) => {
				return null;
			});
